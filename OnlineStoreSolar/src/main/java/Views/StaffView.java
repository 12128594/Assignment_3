...
public class StaffView extends JPanel {
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(positionField, javax.swing.GroupLayout.DEFAULT_SIZE, 315, Short.MAX_VALUE))
                .addContainerGap())
            .addGroup(layout.createSequentialGroup()
                .addContainerGap()
    ...
    private class FormListener implements java.awt.event.ActionListener {
        ...
        public void actionPerformed(java.awt.event.ActionEvent evt) {
            if (evt.getSource() == saveButton) {
                StaffView.this.saveButtonActionPerformed(evt);
            }
            else if (evt.getSource() == refreshButton) {
                StaffView.this.refreshButtonActionPerformed(evt);
            }
            else if (evt.getSource() == newButton) {
                StaffView.this.newButtonActionPerformed(evt);
            }
            else if (evt.getSource() == deleteButton) {
                StaffView.this.deleteButtonActionPerformed(evt);
            }
        }
    ...
    private void deleteButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_deleteButtonActionPerformed
        ...
        List<View.Model.Staff> toRemove = new ArrayList<View.Model.Staff>(selected.length);
        for (int idx = 0; idx < selected.length; idx++) {
            View.Model.Staff s = list.get(masterTable.convertRowIndexToModel(selected[idx]));
            toRemove.add(s);
    ...
    private void newButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_newButtonActionPerformed
        View.Model.Staff s = new View.Model.Staff();
    ...
    private void saveButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_saveButtonActionPerformed
        try {
            ...
            rex.printStackTrace();
            entityManager.getTransaction().begin();
            List<View.Model.Staff> merged = new ArrayList<View.Model.Staff>(list.size());
            for (View.Model.Staff s : list) {
    ...
    private java.util.List<View.Model.Staff> list;
        ...
        EventQueue.invokeLater(new Runnable() {
            public void run() {
             /*   JFrame frame = new JFrame();
                frame.setContentPane(new StaffView());
